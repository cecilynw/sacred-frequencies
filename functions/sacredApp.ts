...
/* ── PRICING ── */
.price-card{border-radius:20px;padding:24px 20px;border:1.5px solid;text-align:center;position:relative;transition:transform 0.2s,box-shadow 0.2s}
.price-card:active{transform:scale(0.98)}
.price-card.popular{border-color:#a78bfa !important;box-shadow:0 0 40px #a78bfa30}
.popular-badge{position:absolute;top:-12px;left:50%;transform:translateX(-50%);background:linear-gradient(135deg,#7c3aed,#a78bfa);color:#fff;font-size:10px;font-weight:800;padding:4px 14px;border-radius:999px;letter-spacing:0.1em;white-space:nowrap}
...
.btn-upgrade{width:100%;padding:13px;border-radius:999px;font-weight:800;font-size:14px;cursor:pointer;border:none;margin-top:16px;-webkit-appearance:none;touch-action:manipulation}
/* ── MODAL ── */
.modal-overlay{display:none;position:fixed;inset:0;background:#00000088;z-index:1000;align-items:center;justify-content:center;padding:20px;backdrop-filter:blur(8px)}
...
.modal-close{position:absolute;top:14px;right:16px;background:transparent;border:none;color:var(--muted);font-size:22px;cursor:pointer;touch-action:manipulation;-webkit-appearance:none}
/* ── GATE BADGE ── */
.gate-badge{display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:999px;font-size:10px;font-weight:800;letter-spacing:0.08em;background:#fbbf2415;color:#fbbf24;border:1px solid #fbbf2430;margin-left:8px;vertical-align:middle}
/* ── EMAIL CAPTURE ── */
...
.email-input{width:100%;padding:12px 16px;border-radius:999px;border:1px solid #334155;background:#0f172a;color:#e2e8f0;font-size:14px;margin:10px 0;outline:none;-webkit-appearance:none}
.email-input:focus{border-color:#a78bfa70}
...
<nav>
  <div class="nav-inner">
    ...
    <div class="nav-tabs">
      ...
      <button class="tab" data-page="vortex" onclick="gateGo('vortex','ascended')">🌀 Vortex <span class="gate-badge" style="background:#fbbf2415;color:#fbbf24;border-color:#fbbf2430">✨</span></button>
      ...
      <button class="tab" data-page="protocol" onclick="gateGo('protocol','ascended')">⚡ Protocol <span class="gate-badge" style="background:#fbbf2415;color:#fbbf24;border-color:#fbbf2430">✨</span></button>
...
<div class="page" id="page-home">
  ...
  <div style="background:linear-gradient(135deg,#0d0520,#0c1a2e);border:1px solid #a78bfa30;border-radius:16px;padding:20px;margin:16px 0;text-align:center">
    ...
    <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
      <button class="btn btn-primary" onclick="showUpgrade('healer')" style="font-size:12px;padding:10px 20px;touch-action:manipulation">💜 Healer — £11/mo</button>
      <button class="btn" onclick="showUpgrade('ascended')" style="font-size:12px;padding:10px 20px;touch-action:manipulation;background:linear-gradient(135deg,#92400e,#fbbf24);color:#fff">✨ Ascended — £33/mo</button>
    </div>
    <div style="font-size:10px;color:var(--dim);margin-top:8px">🔒 Secure payment · Cancel anytime</div>
  </div>
  ...
  <div class="email-capture" id="emailCapture">
    ...
    <div id="emailMsg" style="font-size:12px;color:#34d399;margin-top:8px;display:none">💚 You're in the Sacred Circle! Check your inbox.</div>
  </div>
...
<div class="page" id="page-vortex">
  ...
  <style>@keyframes vcPulse{0%,100%{transform:scale(1)}50%{transform:scale(1.15)}}
/* ── PRICING ── */
.price-card{border-radius:20px;padding:24px 20px;border:1.5px solid;text-align:center;position:relative;transition:transform 0.2s,box-shadow 0.2s}
.price-card:active{transform:scale(0.98)}
.price-card.popular{border-color:#a78bfa !important;box-shadow:0 0 40px #a78bfa30}
...
function devUnlock(tier){
  ...
  closeModal();
  alert('🔓 Dev unlock: ' + tier + ' tier activated!');
}
...
function submitEmail(){
  ...
  document.querySelector('#emailCapture .btn').style.display='none';
  // Auto-show upgrade after 2s
...
<div class="page" id="page-pricing">
  ...
  <div class="grid3" style="margin-bottom:24px;align-items:start">
    ...
    <div class="price-card" style="border-color:#334155;background:var(--card)">
      ...
      <hr style="border:none;border-top:1px solid #1e293b;margin-bottom:14px">
      <div class="price-feat">40 Frequency Tracks</div>
      <div class="price-feat">Healing Journal</div>
      <div class="price-feat">Universal Safety Promise</div>
      <div class="price-feat">App Guide</div>
    ...
    <div class="price-card popular" style="background:linear-gradient(160deg,#0d0520,#0c1a2e)">
      ...
      <hr style="border:none;border-top:1px solid #a78bfa30;margin-bottom:14px">
      <div class="price-feat">Everything in Free</div>
      <div class="price-feat">Angel Numbers (20 sacred codes)</div>
      <div class="price-feat">Nature Portal (6 soundscapes)</div>
      <div class="price-feat">Epigenetic Love (6 stages)</div>
      <div class="price-feat">Growth & Ascension (8 steps)</div>
      <div class="price-feat">Healing Rituals (6 protocols)</div>
      <button class="btn-upgrade" style="background:linear-gradient(135deg,#7c3aed,#a78bfa);color:#fff;box-shadow:0 0 24px #7c3aed40" onclick="showUpgrade('healer')">✦ Activate Healer</button>
    </div>
    ...
    <div class="price-card" style="border-color:#fbbf2440;background:linear-gradient(160deg,#0f0a00,#1a1000)">
      ...
      <div class="price-period">per month</div>
      <hr style="border:none;border-top:1px solid #fbbf2430;margin-bottom:14px">
      <div class="price-feat">Everything in Healer</div>
      <div class="price-feat">9-Ether Protocol (Supreme)</div>
      <div class="price-feat">Quantum Healing Vortex</div>
      <div class="price-feat">Lunar Engine (4 phases)</div>
      <div class="price-feat">Early access to new modules</div>
      <div class="price-feat">Priority support</div>
      <button class="btn-upgrade" style="background:linear-gradient(135deg,#92400e,#fbbf24);color:#fff;box-shadow:0 0 24px #fbbf2430" onclick="showUpgrade('ascended')">⚡ Ascend Now</button>
    </div>
  </div>
  ...
  <div class="card" style="margin-bottom:8px">
    <div style="font-weight:700;font-size:13px;margin-bottom:4px;color:#e2e8f0">Is my payment secure?</div>
    <div style="font-size:12px;color:var(--muted)">Yes — payments are processed securely through Wix Payments. We never store your card details.</div>
  </div>
  <div class="card" style="margin-bottom:8px">
    <div style="font-weight:700;font-size:13px;margin-bottom:4px;color:#e2e8f0">Can I cancel anytime?</div>
    <div style="font-size:12px;color:var(--muted)">Absolutely. Cancel any time from your account — no questions asked.</div>
  </div>
  <div class="card" style="margin-bottom:8px">
    <div style="font-weight:700;font-size:13px;margin-bottom:4px;color:#e2e8f0">Will it work on my iPhone?</div>
    <div style="font-size:12px;color:var(--muted)">Yes — Sacred Frequencies is built first for iOS Safari. Just make sure your silent switch is OFF and volume is up.</div>
  </div>
  <div class="card" style="margin-bottom:24px">
    <div style="font-weight:700;font-size:13px;margin-bottom:4px;color:#e2e8f0">What is the Universal Safety Promise?</div>
    <div style="font-size:12px;color:var(--muted)">528 Hz (love carrier) and 7.83 Hz (Schumann resonance) are embedded in all protocols. Scientifically grounded, safe for all ages.</div>
  </div>
</div>
